...
void desktop_settings_scene_pin_setup_done_on_enter(void* context) {
    ...
    desktop_view_pin_input_set_label_button(
        app->pin_input_view, DESKTOP_SETTINGS_UI_TEXT("Done", "完成"));
    desktop_view_pin_input_set_label_primary(
        app->pin_input_view, 29, 8, DESKTOP_SETTINGS_UI_TEXT("PIN Activated!", "PIN 已启用!"));
    desktop_view_pin_input_set_label_secondary(
        app->pin_input_view,
        7,
        45,
        DESKTOP_SETTINGS_UI_TEXT("Remember or write it down", "请记住或记录下来"));
