...
void momentum_app_scene_start_on_enter(void* context) {
    ...
    item = variable_item_list_add(
        var_item_list, MOMENTUM_UI_TEXT("Interface", "界面"), 0, NULL, app);
    variable_item_set_current_value_text(item, ">");

    item = variable_item_list_add(
        var_item_list, MOMENTUM_UI_TEXT("Protocols", "协议"), 0, NULL, app);
    variable_item_set_current_value_text(item, ">");

    item = variable_item_list_add(var_item_list, MOMENTUM_UI_TEXT("Misc", "杂项"), 0, NULL, app);
    variable_item_set_current_value_text(item, ">");
